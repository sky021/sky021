...
### 📚 Learning & Interests
🧩 **Model Context Protocol (MCP):** building standardized frameworks for multi-model collaboration  
🤖 **Agentic AI Workflows:** developing adaptive, API-integrated agents that automate engineering and decision loops  
☁️ **Cloud AI Pipelines:** optimizing cost-efficient inference systems using AWS & LangChain  
